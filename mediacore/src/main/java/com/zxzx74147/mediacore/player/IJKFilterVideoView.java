 ...
 */
public class IJKFilterVideoView extends SurfaceView implements MediaPlayerControl, IChangeFilter {
...
//    private SurfaceHolder mSurfaceHolder = null;
    ...
    public IJKFilterVideoView(Context context) {
        super(context);
        initVideoView();
    }

    public IJKFilterVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initVideoView();
    }

    public IJKFilterVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(IJKFilterVideoView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(IJKFilterVideoView.class.getName());
    }
...
//            Log.i(TAG,"onFrameAvailable");
    ...
    private static class MainHandler extends Handler {
        ...
        private WeakReference<IJKFilterVideoView> mViewRef = null;

        public MainHandler(IJKFilterVideoView rt) {
        ...
        public void handleMessage(Message msg) {
            ...
            IJKFilterVideoView mVideoView = mViewRef.get();
            if (mVideoView == null) {
