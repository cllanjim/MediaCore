...
package com.zxzx74147.mediacore.player;
 ...
 */
public class FilterVideoView extends SurfaceView implements MediaPlayerControl, IChangeFilter {
...
//    private SurfaceHolder mSurfaceHolder = null;
    ...
    public FilterVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initVideoView();
    }

    public FilterVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(FilterVideoView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(FilterVideoView.class.getName());
    }
...
//            mMediaPlayer.reset();
    ...
    private void onPlayerReady(MediaPlayer player) {
        player.prepareAsync();
    }
...
//        private int mVideoHeight;
        ...
        public void prepareSurface(SurfaceHolder holder, boolean newSurface, MediaPlayer player) {
...
//            Log.i(TAG,"onFrameAvailable");
        ...
        public void surfaceAvailable(SurfaceHolder obj, boolean b, MediaPlayer player) {
    ...
    private static class MainHandler extends Handler {
        ...
        private WeakReference<FilterVideoView> mViewRef = null;

        public MainHandler(FilterVideoView rt) {
            mViewRef = new WeakReference<>(rt);
        }

        public void sendPlayerReady(MediaPlayer player) {
        ...
        public void handleMessage(Message msg) {
            ...
            FilterVideoView mVideoView = mViewRef.get();
            if (mVideoView == null) {
            ...
            switch (what) {
                case MSG_PLAYER_AVALIABLE:
                    mVideoView.onPlayerReady((MediaPlayer) msg.obj);
                    break;
            }
        }
    ...
    private static class RenderHandler extends Handler {
         ...
         * Call from UI thread.
         */
        public void sendSurfaceAvailable(SurfaceHolder holder, boolean newSurface, MediaPlayer player) {
