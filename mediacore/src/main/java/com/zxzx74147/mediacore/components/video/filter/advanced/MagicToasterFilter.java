...
public class MagicToasterFilter extends GPUImageFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/toastermetal.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/toastersoftlight.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/toastercurves.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/toasteroverlaymapwarm.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/toastercolorshift.png");
		    }
	    });
	}
}
