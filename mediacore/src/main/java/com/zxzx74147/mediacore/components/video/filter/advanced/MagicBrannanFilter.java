...
public class MagicBrannanFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/brannan_process.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/brannan_blowout.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/brannan_contrast.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/brannan_luma.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/brannan_screen.png");
		    }
	    });
	}
}
