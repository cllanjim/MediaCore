...
public class MagicSutroFilter extends GPUImageFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/vignette_map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/sutrometal.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/softlight.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/sutroedgeburn.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/sutrocurves.png");
		    }
	    });
	}
}