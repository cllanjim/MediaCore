...
public class MagicSierraFilter extends GPUImageFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/sierravignette.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/sierramap.png");
		    }
	    });
	}
}