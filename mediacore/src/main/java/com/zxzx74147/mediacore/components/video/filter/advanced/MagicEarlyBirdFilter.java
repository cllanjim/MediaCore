...
public class MagicEarlyBirdFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/earlybirdcurves.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/earlybirdoverlaymap_new.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/vignettemap_new.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/earlybirdblowout.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(MediaCore.getContext(), "filter/earlybirdmap.png");
		    }
	    });
	}
}
